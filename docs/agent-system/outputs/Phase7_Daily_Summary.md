...
Generated: 2026-05-18 09:54 ACST
...
| --- | --- | --- | --- | --- |
| 1 Fixtures | ok | 0 | 1.08s | NOTE: Missing API_FOOTBALL_KEY/APISPORTS_KEY; used keyless Flashscore feed. |
| 2 Odds | ok | 0 | 14.14s | total=3 ready_for_phase_3=2 unmatched=1 blocked=0 |
| 3 Team Context | ok | 0 | 41.22s | total=3 ready_for_phase_4=0 unresolved=2 upstream_blocked=1 |
| 4 Predictions | ok | 0 | 0.09s | total=3 ready_for_phase_5=0 model_only=0 upstream_blocked=3 |
| 5 Value & Risk | ok | 0 | 0.09s | total=3 bets=0 leans=0 no_value=0 upstream_blocked=3 scale=1.0 |
| 6 Settlement | ok | 0 | 2.48s | settled_this_run=0 won=0 lost=0 pending=0 history_hit_rate=0.0 history_roi=-1.0 |
| Result Review | ok | 0 | 0.09s | settled_market_rows=1586 weak_spots=12 top_action=Persist model probabilities per market in match_data.json so the revie |
...
| Result Review | 1586 | 12 | match_data.json |
...
- Settled market rows reviewed: 1586
