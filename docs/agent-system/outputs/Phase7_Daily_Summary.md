...
Generated: 2026-05-19 01:54 ACST
Date window: 2026-05-19 to 2026-05-19

## Phase Run Status

| Phase | Status | Exit | Duration | Last line |
| --- | --- | --- | --- | --- |
| 1 Fixtures | ok | 0 | 0.27s | NOTE: Missing API_FOOTBALL_KEY/APISPORTS_KEY; used keyless Flashscore feed. |
| 2 Odds | ok | 0 | 11.22s | total=1 ready_for_phase_3=1 unmatched=0 blocked=0 |
| 3 Team Context | ok | 0 | 22.02s | total=1 ready_for_phase_4=0 unresolved=1 upstream_blocked=0 |
| 4 Predictions | ok | 0 | 0.11s | total=1 ready_for_phase_5=0 model_only=0 upstream_blocked=1 |
| 5 Value & Risk | ok | 0 | 0.12s | total=1 bets=0 leans=0 no_value=0 upstream_blocked=1 scale=1.0 |
| 6 Settlement | ok | 0 | 2.48s | settled_this_run=0 won=0 lost=0 pending=0 history_hit_rate=0.0 history_roi=-1.0 |
| Result Review | ok | 0 | 0.12s | settled_market_rows=1594 weak_spots=12 top_action=Persist model probabilities per market in match_data.json so the revie |
