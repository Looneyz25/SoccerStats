...
REM Stage files. Next.js app on GH Pages reads match_data.json/predictions_*.json.
git add match_data.json predictions_*.json predictions_*.md scripts/ docs/ auto_push.bat run_daily.bat
if errorlevel 1 (
