...
Generated: 2026-05-21 05:58 ACST
...
| --- | --- | --- | --- | --- |
| 1 Fixtures | ok | 0 | 1.44s | NOTE: Missing API_FOOTBALL_KEY/APISPORTS_KEY; used keyless Flashscore feed. |
| 2 Odds | ok | 0 | 18.12s | total=4 ready_for_phase_3=0 unmatched=4 blocked=0 |
| 3 Team Context | ok | 0 | 2.08s | total=4 ready_for_phase_4=0 unresolved=0 upstream_blocked=4 |
| 4 Predictions | ok | 0 | 0.11s | total=4 ready_for_phase_5=0 model_only=0 upstream_blocked=4 |
| 5 Value & Risk | ok | 0 | 0.09s | total=4 bets=0 leans=0 no_value=0 upstream_blocked=4 scale=1.0 |
| 6 Settlement | ok | 0 | 2.12s | settled_this_run=0 won=0 lost=0 pending=0 history_hit_rate=0.0 history_roi=-1.0 |
| Promote Phase Fixtures | ok | 0 | 7.83s | added=0 removed_duplicates=0 to match_data.json |
| Result Review | ok | 0 | 0.11s | settled_market_rows=1609 weak_spots=12 top_action=Persist model probabilities per market in match_data.json so the revie |
...
| Result Review | 1609 | 12 | match_data.json |
...
- Settled market rows reviewed: 1609
