...
Generated: 2026-05-21 18:02 ACST
...
| --- | --- | --- | --- | --- |
| 1 Fixtures | ok | 0 | 1.62s | NOTE: Missing API_FOOTBALL_KEY/APISPORTS_KEY; used keyless Flashscore feed. |
| 2 Odds | ok | 0 | 14.66s | total=1 ready_for_phase_3=1 unmatched=0 blocked=0 |
| 3 Team Context | ok | 0 | 21.92s | total=1 ready_for_phase_4=0 unresolved=1 upstream_blocked=0 |
...
| 6 Settlement | ok | 0 | 1.22s | settled_this_run=0 won=0 lost=0 pending=0 history_hit_rate=0.0 history_roi=-1.0 |
| Promote Phase Fixtures | ok | 0 | 8.56s | added=0 removed_duplicates=0 to match_data.json |
