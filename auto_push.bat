...
REM Stage files Cowork + scripts + GitHub Actions config. index.html is the live app on GH Pages.
git add index.html match_data.json predictions_*.json predictions_*.md scripts/ .github/ auto_push.bat >nul 2>&1
