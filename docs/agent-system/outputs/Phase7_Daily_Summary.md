...
Generated: 2026-05-18 13:54 ACST
...
| 2 Odds | ok | 0 | 12.75s | total=3 ready_for_phase_3=1 unmatched=2 blocked=0 |
| 3 Team Context | ok | 0 | 20.7s | total=3 ready_for_phase_4=0 unresolved=1 upstream_blocked=2 |
...
| 6 Settlement | ok | 0 | 1.67s | settled_this_run=0 won=0 lost=0 pending=0 history_hit_rate=0.0 history_roi=-1.0 |
