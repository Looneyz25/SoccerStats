...
- Team logo badges are mandatory. Every match card must render a visible badge for both home and away teams on mobile and desktop; if a logo URL is missing or fails, keep the same badge shape and show the team initials fallback instead of removing the badge.
